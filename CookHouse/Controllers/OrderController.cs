...
namespace CookHouse.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public ActionResult ListOrder(int? page, int? cityId, string madonhang, string fromdate, string todate, string customerName, string customerEmail, string customerMobile, int status = 0, int payment = 0, int pageSize = 50)
        {
