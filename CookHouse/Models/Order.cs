...
namespace CookHouse.Models
{
    ...
    public class CustomerInfo
    {
        ...
        [Display(Name = "Điện thoại *"), Required(ErrorMessage = "Hãy nhập điện thoại"), RegularExpression(@"0\d{9}$", ErrorMessage = "Số điện thoại không hợp lệ"), StringLength(11, MinimumLength = 7, ErrorMessage = "Điện thoại từ 7, 11 ký tự"), UIHint("TextBox")]
